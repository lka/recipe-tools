...
Hinweise:
- `recipe_name` unveraendert uebergeben (Sanitisierung erfolgt automatisch)
- Kein Bildpfad noetig – Foto wird automatisch aus tmp/ zugeordnet

### 4. Qualitaetspruefung
Die HTML-Datei wird automatisch im Browser geoeffnet. Bei Fehlern: `build_recipe_html_tool` erneut aufrufen.
